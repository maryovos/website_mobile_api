...
Mobile.setText(findTestObject('MobileAndroid/txt_username'), GlobalVariable.username_mobile, 0)

Mobile.hideKeyboard()

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('MobileAndroid/txt_password'), 0)

Mobile.setText(findTestObject('MobileAndroid/txt_password'), GlobalVariable.password_mobile, 0)

Mobile.hideKeyboard()

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('MobileAndroid/btn_login'), 0)
